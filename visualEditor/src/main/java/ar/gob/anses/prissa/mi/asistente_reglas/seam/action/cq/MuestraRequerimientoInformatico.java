...
@Entity
@Name("muestraReqInformatico")
@PrimaryKeyJoinColumn(name="requerimiento_id")
public class MuestraRequerimientoInformatico extends RequerimientoInformatico {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6827915727400471481L;
