...
package ar.gob.anses.prissa.mi.asistente_reglas.stuff;
...
import ar.gob.anses.prissa.mi.asistente_reglas.services.DiferenciasService.Estado;
...
public class DiffMatchPatch {
	 ...
	 * @return HTML representation.
	 */
	public String diff_myHtml(LinkedList<Diff> diffs) {
		StringBuilder html = new StringBuilder();
		int i = 0;
		...
		for (Diff aDiff : diffs) {
			...
			case INSERT:
				html.append(
						"<SPAN STYLE=\"background:#9BBB59;\" TITLE=\"i=").append(i).append("\">")
						.append(text).append("</SPAN>");
				break;
			case DELETE:
				html.append(
						"<SPAN STYLE=\"background:" + Estado.ELIMINADO.color()
								+ ";\" TITLE=\"i=").append(i).append("\">")
						.append(text).append("</SPAN>");
				break;
			case EQUAL:
				html.append("<SPAN TITLE=\"i=").append(i).append("\">").append(
		...
		int line = 1;
		String[] lines =  html.toString().split("&para;<BR>");
		StringBuilder html2 = new StringBuilder();
		for (int j = 0; j < lines.length; j++) {
			html2.append("<font style=\"background-color:#C0C0C0;padding-right:10px;text-align: left\">"+ (line++) +"</font>");
			html2.append(lines[j]).append("<BR>");
		}
