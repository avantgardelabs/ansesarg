...
public class JLinkButton extends JButton implements TableCellRenderer {
	...
	public static void main(String[] a) throws Exception {
		...
		f.getContentPane().add(
				new JLinkButton("JAVA2", new URL("http://www.java2s.com")));
		f.getContentPane().add(
				new JLinkButton(
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		JLinkButton jlk = (JLinkButton) value;
		jlk.setText(this.getText());
		jlk.setHorizontalAlignment(SwingConstants.CENTER);
		return jlk;
