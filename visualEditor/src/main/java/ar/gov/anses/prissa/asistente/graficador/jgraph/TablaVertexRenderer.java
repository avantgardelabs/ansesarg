...
import ar.gov.anses.prissa.asistente.graficador.modeloresumido.jgraph.TablaToTableModelAdapterMR;

public class TablaVertexRenderer implements CellViewRenderer {
    
    private static final long serialVersionUID = 5383639336146693578L;

    private TablaVertexView view;
	private Tabla myModel;
	private JTable mainTable;
	private JPanel mainPanel;
    
    public TablaVertexRenderer(Tabla view) {
        this.myModel = view;
        mainTable = new JTable();
		mainTable.setModel(new TablaToTableModelAdapter(this.myModel));		
        this.init();
    }
    private void init() {
...
//		};
    ...
    public Tabla getMyModel() {
		return myModel;
	}
	public void setMyModel(Tabla myModel) {
