...
public class ColumnaPortViewMR extends PortView {

    private static final long serialVersionUID = 9176253732742047888L;
    
    private boolean localizacionAdaptativa;
    
    public ColumnaPortViewMR(Object cell) {
        this(cell, false);
    }
    
    public ColumnaPortViewMR(Object cell, boolean localizacionAdaptativa) {
        super(cell);
    ...
    private double getOffset(double defaultOffset) {
        ...
        ColumnaMR columna = this.getColumna();
    ...
    private ColumnaMR getColumna() {
        return ColumnaMR.class.cast(DefaultPort.class.cast(this.getCell())
                                    .getUserObject());
    }
    ...
    public Point2D getLocation() {
        ...
        if (true/*this.getColumna().tieneVinculo()*/) {
